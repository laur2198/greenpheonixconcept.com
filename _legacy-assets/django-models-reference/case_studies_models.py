...
class StudiuDeCaz(models.Model):
    ...
    nisa = models.CharField(max_length=200, blank=True, help_text="Ex: Transport persoane — Diaspora România–Germania")
    problema = models.TextField(blank=True, help_text="Problema pe care a avut-o clientul")
    perioada = models.CharField(max_length=100, blank=True, help_text="Ex: Ianuarie 2026 – prezent")
    imagine_cover = models.ImageField(upload_to="studii/covers/", blank=True)
    logo_client = models.ImageField(upload_to="studii/logos/", blank=True, null=True)
