...
SECRET_KEY = config("SECRET_KEY", default="django-insecure-dev-key-schimba-in-productie")
...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = config("DEFAULT_FROM_EMAIL", default="contact@greenpheonixconcept.com")
CONTACT_RECIPIENT_EMAIL = config("CONTACT_RECIPIENT_EMAIL", default="contact@greenpheonixconcept.com")

# BT Pay
BT_PAY_MERCHANT_ID = config("BT_PAY_MERCHANT_ID", default="")
